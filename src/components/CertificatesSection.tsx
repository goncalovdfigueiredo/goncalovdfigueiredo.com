...
export default function ScientificOutreachSection() {
  ...
  return (
    ...
    <section id="scientific Outreach and Certifications" className="py-20 md:py-24 relative overflow-hidden">
      ...
      <div className="container max-w-5xl mx-auto px-4 md:px-8 relative z-10 flex flex-col h-full">
        
        <MotionWrapper>
          {/* CABEÇALHO DA SECÇÃO */}
          <div className="mb-10 md:mb-12 flex flex-col md:flex-row md:items-start justify-between gap-6">
            <div className="flex flex-col gap-4">
              <h2 className="text-3xl md:text-4xl font-bold flex items-center tracking-tight text-zinc-900 dark:text-white">
                <div className="p-3 rounded-xl bg-emerald-500/10 border border-emerald-500/20 mr-4">
