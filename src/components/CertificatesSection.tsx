...
const certs = [
  {
    ...
    },
    {
      ...
      items: [
        { title: "AI for ICs and ICs for AI: Summer School", org: "POEMS: Portuguese Competence Centre in Semiconductors", year: "2026", link: "https://www.poemscentre.eu/en/ai-for-ics-and-ics-for-ai-summer-school/2026"  },
...
export default function ScientificOutreachSection() {
  ...
  return (
    <section id="scientific Outreach and Certifications" className="py-20 md:py-24 relative overflow-hidden">
      ...
      <div className="container max-w-7xl mx-auto px-4 md:px-8 relative z-10 flex flex-col h-full">
