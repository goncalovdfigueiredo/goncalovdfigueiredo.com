...
function TypewriterExpertise() {
  ...
  return (
    <span className="notranslate relative text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-cyan-600 md:from-emerald-500 md:to-cyan-400 font-bold drop-shadow-[0_0_10px_rgba(16,185,129,0.2)] md:drop-shadow-[0_0_10px_rgba(16,185,129,0.4)]">
      {currentText}
      <motion.span animate={{ opacity: [1, 0] }} transition={{ duration: 0.5, repeat: Infinity }} className="absolute -right-2 top-0 bottom-0 md:top-1 md:bottom-1 w-[3px] md:w-[2px] bg-emerald-500 md:bg-emerald-400 shadow-[0_0_8px_#34d399]" />
    </span>
  );
}
...
function DisintegratingProfile() {
  ...
  return (
    <div className="relative w-24 h-24 md:w-44 md:h-44 group flex items-center justify-center">
      ...
      <a href="/CV_Goncalo_Figueiredo.pdf" download className="absolute -bottom-1 -right-4 md:-bottom-2 md:-right-4 flex items-center gap-1.5 bg-zinc-900 text-white px-3 py-1.5 md:px-4 md:py-2 rounded-full font-bold text-[10px] md:text-xs shadow-lg hover:scale-110 transition-transform z-50 pointer-events-auto">
