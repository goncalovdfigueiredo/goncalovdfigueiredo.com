...
export const education = [
  {
    ...
    logo: "/IST.png",
    relatedSkills: ["Visible Light Communications","Luminescent Solar Concentrators", "PCB Design",  "Optoelectronic Prototyping", "IoT & Smart City Infrastructure","Altium Designer & KiCad", "Intel Quartus Prime", 
      "LTspice",
      "Visual Studio Code",
      "Apache Spark", "Python (Data Science & Control)", 
  ...
  },
  {
    ...
    relatedSkills: ["Visible Light Communications","Physical Layer Security & Cryptography", "Optoelectronic Prototyping",
      "Visual Studio Code",
  ...
  },
  {
    ...
    relatedSkills: ["Visible Light Communications",  "Optoelectronic Prototyping",
